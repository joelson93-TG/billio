  ...
  useEffect(() => {
    ...
    const unsubscribeAuth = onAuthStateChanged(auth, (currentUser: any) => {
      ...
      unsubUser = onSnapshot(
        ...
        (error) => console.warn("Listener user arrêté :", error.message)
      );
      ...
      unsubInvoices = onSnapshot(
        ...
        (error) => console.warn("Listener invoices arrêté :", error.message)
      );
      ...
      unsubCustomers = onSnapshot(
        ...
        (error) => console.warn("Listener customers arrêté :", error.message)
      );
